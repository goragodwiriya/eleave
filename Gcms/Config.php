...
class Config extends \Kotchasan\Config
{
    ...
    /**
     * เดือนที่สิ้นสุดปีงบประมาณ
     * สำหรับการเริ่มปีงบประมาณใหม่
     * เช่น 1 หมายถึง วันที่ 1 เดือน มกราคมของทุกปี
     *
     * @var int
     */
    public $eleave_fiscal_year = 1;
    /**
     * ชนิดของไฟล์ที่สามารถอัปโหลดได้
     *
     * @var array
     */
    public $eleave_file_typies = ['jpg', 'jpeg', 'pdf', 'webp'];
    /**
     * ขนาดไฟล์อัปโหลดสูงสุด (ไบต์)
     *
     * @var int
     */
    public $eleave_upload_size = 2097152;
    /**
     * จำนวนวันที่หัก สำหรับช่วงเวลาที่ลา
     *
     * @var array
     */
    public $eleave_periods = [
        // เต็มวัน
        0 => 1,
        // ครึ่งวันเช้า
        1 => 0.5,
     ...
     * @var int
     */
    public $eleave_approve_level = 1;
    /**
     * สถานะอนุมัติ
     *
     * @var array
     */
    public $eleave_approve_status = [
        1 => 0
    ];
    /**
     * แผนกผู้อนุมัติ
     ...
     * @var array
     */
    public $eleave_approve_department = [
        1 => '1'
    ];
}
